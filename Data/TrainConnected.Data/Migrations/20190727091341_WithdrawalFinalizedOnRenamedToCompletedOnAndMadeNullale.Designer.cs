...
namespace TrainConnected.Data.Migrations
{
    ...
    [Migration("20190727091341_WithdrawalFinalizedOnRenamedToCompletedOnAndMadeNullale")]
    partial class WithdrawalFinalizedOnRenamedToCompletedOnAndMadeNullale
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainConnected.Data.Models.PaymentMethod", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<bool>("PaymentInAdvance");
            ...
            modelBuilder.Entity("TrainConnected.Data.Models.WorkoutsPaymentMethods", b =>
                {
                    b.Property<string>("WorkoutId");

                    b.Property<string>("PaymentMethodId");

                    b.HasKey("WorkoutId", "PaymentMethodId");

                    b.HasIndex("PaymentMethodId");

                    b.ToTable("WorkoutsPaymentMethods");
                });
            ...
            modelBuilder.Entity("TrainConnected.Data.Models.Booking", b =>
                {
                    b.HasOne("TrainConnected.Data.Models.PaymentMethod", "PaymentMethod")
                        .WithMany()
            ...
            modelBuilder.Entity("TrainConnected.Data.Models.Withdrawal", b =>
                {
                    b.HasOne("TrainConnected.Data.Models.TrainConnectedUser", "ProcessedByUser")
                        .WithMany()
