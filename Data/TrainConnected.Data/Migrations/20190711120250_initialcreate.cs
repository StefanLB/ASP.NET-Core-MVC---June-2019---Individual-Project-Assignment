    ...
    public partial class initialcreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUsersWorkouts", x => new { x.UserId, x.WorkoutId });
                    table.ForeignKey(
                        name: "FK_ApplicationUsersWorkouts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationUsersWorkouts_Workouts_WorkoutId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUsersWorkouts_WorkoutId",
                table: "ApplicationUsersWorkouts",
                column: "WorkoutId");
