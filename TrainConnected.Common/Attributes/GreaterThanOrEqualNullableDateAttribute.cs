namespace TrainConnected.Common.Attributes
{
    using System;
    using System.ComponentModel.DataAnnotations;

    public sealed class GreaterThanOrEqualNullableDateAttribute : ValidationAttribute
    {
        private readonly string comparisonProperty;

        public GreaterThanOrEqualNullableDateAttribute(string comparisonProperty)
        {
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            // If no date was selected, comparison is skipped
            if (value == null)
            {
